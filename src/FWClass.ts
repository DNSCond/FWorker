...
export class FWRequest {
    ...
    public headers: FWHeaders;

    constructor(input: RequestInfo | URL | FWRequest | string, init?: RequestInit) {
        ...
        } else if ((typeof input === 'string') || init) {
            init = Object(init);
